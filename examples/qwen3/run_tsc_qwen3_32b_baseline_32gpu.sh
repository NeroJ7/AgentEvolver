...
log_file="logs/qwen3/qwen3_32b_sparse_baseline1_${current_time}.log"
experiment_name="qwen3_32b_sparse_baseline1"
# Ray
...
ray job submit --address="$RAY_ADDRESS" \
    ...
    trainer.experiment_name="qwen3_32b_sparse_baseline1" \
    trainer.nnodes=4 \
    trainer.save_freq=10 \
    trainer.test_freq=10 \
    trainer.total_epochs=60 \
    trainer.val_before_train=True \
    trainer.validation_data_dir="experiments/exp_qwen3_32b_sparse_baseline1_${current_time}/validation_log" \
    trainer.rollout_data_dir="experiments/exp_qwen3_32b_sparse_baseline1_${current_time}/rollout_log" \
