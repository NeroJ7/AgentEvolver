...
suffix="qwen3_14b_sparse_sem_turbo_bad0.2_negbad-0.2_respmask1_trbs8_ppobs8"
...
python3 -m beyondagent.main_ppo \
    ...
    trainer.validation_data_dir="experiments/exp_${suffix}_${current_time}/validation_log" \
    trainer.rollout_data_dir="experiments/exp_${suffix}_${current_time}/rollout_log" \
